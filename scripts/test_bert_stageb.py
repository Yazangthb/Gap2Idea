...
Usage:
    python scripts/test_bert_stageb.py --model distilbert-base-uncased --epochs 4
    python scripts/test_bert_stageb.py --model distilbert-base-uncased --distant
    python scripts/test_bert_stageb.py --model allenai/scibert_scivocab_uncased
"""
